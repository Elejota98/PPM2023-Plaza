...
{
    [DataContract(Name = "ServiceArqueos", Namespace = "http://www.MillensCorp.com/types/")]
    public class Arqueos
    {
        ...
        private int _CantTransacciones;        
        private double _Producido;       
        private string _Tipo;       
        private double _Conteo;      
