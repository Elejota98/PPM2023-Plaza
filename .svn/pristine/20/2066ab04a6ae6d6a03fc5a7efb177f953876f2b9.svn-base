...
{
    [DataContract(Name = "ServiceDtoTalanquera", Namespace = "http://www.MillensCorp.com/types/")]
    public class DtoTalanquera
    {
        private long _IdEventoDispositivo;
        ...
        {
            get { return _IdEventoDispositivo; }
            set { _IdEventoDispositivo = value; }
        }
        [DataMember]
