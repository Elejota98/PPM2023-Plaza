...
namespace MC.EnvioImagenesCloud
{
    public partial class EnvioCloudService : ServiceBase
    {
        ...
        private static EnvioCloudService Agente = new EnvioCloudService();
                    ...
                    if (Directory.Exists(_RutaImagenesEnvio))
                    {
                        ...
                        if (oFiles.Length > 0)
                        {
                            ...
                            if (olstImagenes != null)
                            {
                                ...
                                {
                                    ResultadoOperacion oResultadoOperacion = _ProxyServicios.EnviarImagenesServidorCloud(olstImagenes);
