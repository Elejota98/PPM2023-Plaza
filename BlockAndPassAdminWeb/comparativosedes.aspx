...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="comparativosedes.aspx.cs" Inherits="BlockAndPass.AdminWeb.comparativosedes" %>
    ...
    <head>
	    ...
	    <script type="text/javascript">
	        ...
	        function ConsultarListaReportes() {
	            $.ajax({
	                type: "GET",
	                url: "DataService.asmx/ObtenerListaReportes?idTipo=" + 10,
	                data: "{}",
	                contentType: "application/json",
	                dataType: "json",
	                success: function (msg) {
            ...
            <div class="main-panel">
                ...
                <div class="content">
                    <div class="container-fluid">
                        <nav class="navbar navbar-default" id="myNav">
                            <div class="collapse navbar-collapse">
                                <ul class="nav navbar-nav nav-tabs-justified">
                                    ...
                                    <li id="navReportesEstadisticos" class="active"><a href="#">Estadisticos</a></li>
                                    <%--<li id="navReportesAlarmas"><a href="repAlarmas.aspx">Alarmas</a></li>
                                    <li id="navReportesComparativo" class="active"><a href="#">Comparativo Sedes</a></li>
                        ...
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Reportes Estadisticos</h4>
                            </div>
                            <div class="content">
                                <div class="row">
                                    <div class="col-md-4">
