<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="convenios.aspx.cs" Inherits="BlockAndPass.AdminWeb.convenios" %>
    ...
    <head>
	    ...
	    <script type="text/javascript">
	        ...
	        function mifuncion() {
	            $.ajax({
	                type: "GET",
	                url: "DataService.asmx/GetItemsConvenios",
	                data: "",
	                contentType: "application/json",
	                dataType: "json",
	                success: function (msg) {
	        ...
	        function btnEditar_click(e) {
	            ...
	            var IdConvenio = data[0];
	            var IdSede = data[8];
	            var IdEstacionamiento = data[3];
	            var Estado = data[7];
	            var nombre = data[1];
	        ...
	        function btnModalGuardar_click() {
	            if ($('.modal-title').html() == 'Crear') {
	                ...
	                $.ajax({
	                    type: "GET",
	                    url: "DataService.asmx/CrearConvenio?&idEstacionamiento=" + $('#idEstacionamientoModal').val() + "&nombre=" + $('#nombreModal').val() + "&descripcion=" + $('#descripcionModal').val() + "&fechaInicial=" + date + "&fechaFinal=" + date2 + "&estado=" + activo,
	                    data: "",
	                    contentType: "application/json",
	                    dataType: "json",
	                    success: function (msg) {
	                ...
	                $.ajax({
	                    type: "GET",
	                    url: "DataService.asmx/ActualizarConvenio?idConvenio=" + $('#idConvenioModal').val() + "&idEstacionamiento=" + $('#idEstacionamientoModal').val() + "&nombre=" + $('#nombreModal').val() + "&descripcion=" + $('#descripcionModal').val() + "&fechaInicial=" + date + "&fechaFinal=" + date2 + "&estado=" + activo,
	                    data: "",
	                    contentType: "application/json",
	                    dataType: "json",
	                    success: function (msg) {
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control border-input" disabled id="idConvenioModal">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control border-input" type="text" name="date1" value="" id="fechaInicioModal">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
