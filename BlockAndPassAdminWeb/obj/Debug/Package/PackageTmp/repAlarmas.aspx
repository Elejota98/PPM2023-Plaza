...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="repAlarmas.aspx.cs" Inherits="BlockAndPass.AdminWeb.repAlarmas" %>
    ...
    <head>
	    ...
	    <script type="text/javascript">
	        ...
	        function ConsultarListaReportes() {
	            $.ajax({
	                type: "GET",
	                url: "DataService.asmx/ObtenerListaReportes?idTipo=" + 6,
	                data: "{}",
	                contentType: "application/json",
	                dataType: "json",
	                success: function (msg) {
            ...
            <div class="main-panel">
                ...
                <div class="content">
                    <div class="container-fluid">
                        <nav class="navbar navbar-default" id="myNav">
                            <div class="collapse navbar-collapse">
                                <ul class="nav navbar-nav nav-tabs-justified">
                                    ...
                                    <li id="navReportesAlarmas" class="active"><a href="#">Alarmas</a></li>
                        ...
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Reportes de Alarmas</h4>
                            </div>
                            <div class="content">
                                <div class="row">
                                    <div class="col-md-4">
