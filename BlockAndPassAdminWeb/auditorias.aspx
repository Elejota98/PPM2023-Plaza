...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="auditorias.aspx.cs" Inherits="BlockAndPass.AdminWeb.auditorias" %>
    ...
    <head>
	    ...
	    <script type="text/javascript">
	        ...
	        function ConsultarListaReportes() {
	            $.ajax({
	                type: "GET",
	                url: "DataService.asmx/ObtenerListaReportes?idTipo=" + 5,
	                data: "{}",
	                contentType: "application/json",
	                dataType: "json",
	                success: function (msg) {
            ...
            <div class="main-panel">
                ...
                <div class="content">
                    <div class="container-fluid">
                        <nav class="navbar navbar-default" id="myNav">
                            <div class="collapse navbar-collapse">
                                <ul class="nav navbar-nav nav-tabs-justified">
                                    ...
                                    <li id="navReportesAuditorias" class="active"><a href="#">Auditorias</a></li>
                                    <li id="navReportesEstadisticos"><a href="comparativosedes.aspx">Estadisticos</a></li>
                        ...
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Reportes de Auditoria</h4>
                            </div>
                            <div class="content">
                                <div class="row">
                                    <div class="col-md-4">
